...
📺 Полное видео-демо (50 сек): [demo/using.mp4](demo/using.mp4)
...
rdr поддерживает перевод и суммаризацию статей через OpenAI-совместимые API и локальные CLI-провайдеры: Claude Code, pi и opencode. Подробнее: [`docs/ai.md`](docs/ai.md).
